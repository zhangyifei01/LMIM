...
from masking_generator import RandomMaskingGenerator, RandomColMaskingGenerator
...
class DataAugmentationForMAE(object):
    def __init__(self, args):
        ...
        self.image_masked_position_generator = RandomMaskingGenerator(args.window_size, args.mask_ratio, num_view=1)
