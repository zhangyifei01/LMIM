...
def get_args():
    ...
    parser.add_argument('--other_test_data_folders', type=str, nargs='+',
                        ...
                        default=['artistic', 'contextless', 'curve', 'multi_oriented', 'multi_words', 'salient'])
    ...
    parser.add_argument('--train_url', default='/home/xxxxx/xxxxxx/outputs/train_url_0/', type=str,)
...
def main(args, ds_init):
    ...
    if args.finetune:
        ...
        # print(all_keys)
        # print(cur_keys) #  encoder.
        new_dict = OrderedDict()
        for key in all_keys:
            if key.startswith('model_maeenc.'):
                key_tmp = key[13:]
                # print(key_tmp)
            else:
                key_tmp = key
            if ('encoder.' + key_tmp) not in cur_keys:
                del checkpoint_model[key]
            else:
                new_dict['encoder.' + key_tmp] = checkpoint_model[key]
